							...
							if (this._helper) {
								var pr = this._proportionallyResizeElements, ista = pr.length
										...
										&& $.ui.hasScroll(pr[0], 'left') /*
																			 ...
																			 * jump
																			 * height
																			 */? 0 : that.sizeDiff.height, soffsetw = ista ? 0
										: that.sizeDiff.width;
	...
	function Datepicker() {
		...
		this.regional[''] = { // Default regional settings
			...
			monthNames : [ 'Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio',
					...
					'Novembro', 'Dezembro' ], // Names of months for drop-down
			// and formatting
			monthNamesShort : [ 'Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun',
					'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez' ], // For
			// formatting
			dayNames : [ 'Domingo', 'Segunda', 'Terça', 'Quarta',
					'Quinta', 'Sexta', 'Sabado' ], // For formatting
			dayNamesShort : [ 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab' ], // For
			// formatting
			dayNamesMin : [ 'Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'Sab' ], // Column
			// headings
			// for
			// days
			// starting
			// at
			// Sunday
			weekHeader : 'MES', // Column header for week of the year
		...
		$.widget("ui.tabs", $.ui.tabs, {
			...
			_trigger : function(type, event, data) {
				...
				if (type === "beforeActivate") {
					...
					panel = data.newPanel.length ? data.newPanel
							: data.oldPanel;
